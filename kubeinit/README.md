...
## Requirements checks
### Intro
This is by no means distribution agnostic and is only added here to help you get your requirements in order.
...
nslookup nyctea
```
if it fails, edit your /etc/hosts, your DNS or your inventory files 
